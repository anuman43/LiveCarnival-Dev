  ...
  <script src="https://www.travelnow.com/templates/490695/static/6/default/js/yui2/yuiloader/yuiloader-min.js"><!-- --></script>

<!-- Loads the calendar locale. -->
<script src="https://www.travelnow.com/templates/490695/static/6/default/js/locales/locale_en.js"><!-- --></script>
    
    <!-- styles/expediaSearchWidget.cs -->
     <link rel="stylesheet" type="text/css" href="${baseURL}/resources/styles/expediaSW112115.css"/>
...
var SearchWidget = {
    ...
    decorateSearch : function() {
        ...
        self.YAHOO.util.Event.on(self.YAHOO.util.Dom.get(self.SEARCH_ID), "click", function() {
            ...
            var url = "https://www.travelnow.com/templates/490695/searchWidget?autosearch=true";
...
var searchWidgetYahooUIloader = new YAHOO.util.YUILoader({
    ...
    base: 'https://www.travelnow.com/templates/490695/static/6/default/js/yui2/'
...
if (typeof YAHOO == "undefined" || typeof YAHOO.widget == "undefined" || YAHOO.widget.Calendar == "undefined"
   ...
   <div class="search-widget size336x280A">
