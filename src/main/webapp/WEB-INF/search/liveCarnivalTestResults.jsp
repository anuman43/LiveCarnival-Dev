				...
				<c:choose>
					...
					<c:when test="${not empty searchModel['mainSearch']}">
						...
						<div class="list-group">
						  <a href="<c:out value="${result.resultUrl}"/>" class="list-group-item active">
						    <h4 class="list-group-item-heading"><c:out value="${result.resultPageTitle}"></c:out> </h4>
						    <p class="list-group-item-text"><c:out value="${result.resultUrl}"/></p>
						  </a>
						</div>
						</c:forEach>
