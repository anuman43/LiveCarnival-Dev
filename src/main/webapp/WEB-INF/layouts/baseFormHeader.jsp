...
$(document).ready(function()
	...
	var liveCarnivals = new Bloodhound({
		...
		var carnivalCountries = new Bloodhound({
			  datumTokenizer: Bloodhound.tokenizers.whitespace,
			  queryTokenizer: Bloodhound.tokenizers.whitespace,
			  local:  ["Antigua and Barbuda","Anguilla","Aruba","Bahamas","Belieze","Barbados","Bermuda","Canada","Cayman Islands","Cuba","Curacao","Dominica","Dominican Republic","Grenada","Guadeloupe","Haiti",
						  "Jamaica","Martinique","Puerto Rico","Brazil","Saint Barthélemy","St Croix US VI","St. Kitts & Nevis","St. Lucia","St Maarteen","St Thomas US VI","St. Vincent and the Grenadines","Trinidad & Tobago","Turks & Caicos Islands",
						  "Virgin Islands","United Kindom","United States","Belize","Costa Rica","El Salvador","Guatemala","Honduras","Mexico","Nicaragua","Panama","Venezuela"]
			});
	
			var cities = new Bloodhound ({
				datumTokenizer: Bloodhound.tokenizers.whitespace,
				queryTokenizer: Bloodhound.tokenizers.whitespace,
				local: ["Port-Of-Spain","San Fernando","Chaguanas","Piarco","Arima","Scaborough","Pigeon Point","Bridgetown","Castries","Soufrere","Saint George","Kingstown",
						"Kingston","MontegoBay","Negril","New Kingstown","Saint John","Saint Johns","Saint Mark","Saint Patrick","Saint David","Washington DC","Atlanta","Miami","Brooklyn","Manhattan","Boston","San Fransisco"]
			...
			var states = new Bloodhound ({
				datumTokenizer: Bloodhound.tokenizers.whitespace,
				queryTokenizer: Bloodhound.tokenizers.whitespace,
				local: ["Alabama","Alaska","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana"
						,"Iowa","Kansas","Kentucky","Lousiana","Maine","Massachusetts","Michigan","Minnesota","Mississipi","Missouri","Montana","Nebraska","Nevada","New Hampshire","New Jersey","New Mexico","New York","North Carolina","North Dakota","Ohio",
						"Oklahoma","Oregon","Pennsylvania","Rhode Island","South Carolina","South Dakota","Tennesee","Texas","Utah","Vermont","Virginia","Washington","West Virigina","Wyoming","Wisconsin"]
			
			
			});

			states.initialize();
			$("#statesText").typeahead({
				  items: 4,
				  source:states.ttAdapter()
				});
			
			
			//intialize the bloodhoud suggestion engine for states
			cities.initialize();
			$("#citiesText").typeahead({
				  items: 4,
				  source:cities.ttAdapter()
				});
			// initialize the bloodhound suggestion engine
			carnivalCountries.initialize();

			$("#countryText").typeahead({
			  items: 4,
			  source:carnivalCountries.ttAdapter()
			});
